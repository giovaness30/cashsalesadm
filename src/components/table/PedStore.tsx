...
export default function inputSelect() {
  ...
  useEffect(() => {
    API.get(`/pedido?cpfcnpj=${cnpj}`, optionsApi)
      .then(res => {
        setCompanys(
